...
def run():
    ...
    _remoteUbicacion="http://archimedes.mpiwg-berlin.mpg.de/cgi-bin/toc/toc.cgi?page=%d;dir=salus_mathe_040_en_1667;step=textonly;xml=show"
    _remoteUrl = _remoteUbicacion
    _localUrl  = _localUbicacion+"/%04d.txt"
    global _init
    _init=1
    #_end=226+1
    _end=1206 +1
